...
| spi_host.[`CONFIGOPTS_0`](#configopts)   | 0x18     |        4 | Configuration options register.                          |
| spi_host.[`CONFIGOPTS_1`](#configopts)   | 0x1c     |        4 | Configuration options register.                          |
| spi_host.[`CSID`](#csid)                 | 0x20     |        4 | Chip-Select ID                                           |
| spi_host.[`COMMAND`](#command)           | 0x24     |        4 | Command Register                                         |
...
|   22   |   ro   |    x    | BYTEORDER | The value of the ByteOrder parameter, provided so that firmware    can confirm proper IP configuration.                                                                          |
|   21   |        |         |           | Reserved                                                                                                                                                                         |
...
```wavejson
{"reg": [{"name": "LEN", "bits": 24, "attr": ["wo"], "rotate": 0}, {"name": "CSAAT", "bits": 1, "attr": ["wo"], "rotate": -90}, {"name": "SPEED", "bits": 2, "attr": ["wo"], "rotate": -90}, {"name": "DIRECTION", "bits": 2, "attr": ["wo"], "rotate": -90}, {"bits": 3}], "config": {"lanes": 1, "fontsize": 10, "vspace": 110}}
```

|  Bits  |  Type  |  Reset  | Name                             |
|:------:|:------:|:-------:|:---------------------------------|
| 31:29  |        |         | Reserved                         |
| 28:27  |   wo   |   0x0   | [DIRECTION](#command--direction) |
| 26:25  |   wo   |   0x0   | [SPEED](#command--speed)         |
|   24   |   wo   |   0x0   | [CSAAT](#command--csaat)         |
|  23:0  |   wo   |   0x0   | [LEN](#command--len)             |
