...
# Description: Script to generate the xheep_spi (spi_subsystem) registers

PERIPHERAL_NAME=spi_subsystem

REG_DIR=$(dirname -- $0)
ROOT="$(dirname -- $0)/.."
REGTOOL=$ROOT/vendor/pulp_platform_register_interface/vendor/lowrisc_opentitan/util/regtool.py
